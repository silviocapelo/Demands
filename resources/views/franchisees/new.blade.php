        ...
        <div class="card-header">   
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2" placeholder="Número">
                        ...
                        <input type="text" name="number" class="form-control" id="imputNstreet" placeholder="">
                    </select>
                </div>
                <div class="form-group col-md-4">
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <input type="bfh-phone" name="telefone" data-mask="(00)0000-0000" class="form-control" id="inputFone" placeholder="" pattern="\([0-9]{2}\)[0-9]{4,6}-[0-9]{3,4}$" required>
                </div>
                <div class="form-group col-md-3">
                    <label for="inputFone"  class="control-label">Celular</label>
                    <input type="text" name="cell_fone" data-mask="(00)00000-0000" class="form-control" id="inputCel" placeholder="" required>
                </div>
                <div class="form-group col-md-3">
                    <label for="">CNPJ</label>
                    <input type="text" name="cnpj"  data-mask="00.000.000/0000-00"  class="form-control" id="inputCPF">
                </div>
                <div class="form-group col-md-3">
